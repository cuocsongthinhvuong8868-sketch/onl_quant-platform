...
- Với câu hỏi NAV, tỷ trọng, phân bổ danh mục, quyết định mua/bán, phân tích ticker/ngành hoặc bối cảnh vĩ mô, phải lấy `get_tool_metrics` làm system-risk context trước khi kết luận về mã cổ phiếu.
...
- `get_tool_metrics` là context rủi ro toàn thị trường; không yêu cầu adapter riêng cho ngành hoặc ticker mới được sử dụng context này.
