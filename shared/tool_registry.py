...
TOOL_REGISTRY: tuple[ToolDefinition, ...] = (
    ...
    ToolDefinition(
        ...
        desc="PCA & EGARCH — Fear/Greed v2.1 qua point-in-time PCA, EGARCH, Kelly skewness, CSV dispersion và acute selloff overlay",
    ...
    ToolDefinition(
        ...
        desc="Hybrid MC Bidirectional Breadth Model — Upside/downside participation, strict no-fill returns, stress regime và deterministic MC ensemble",
    ...
    ToolDefinition(
        ...
        branch="behavioral",
        name="🔄 Dispersion",
        desc="CSAD/CSSD + DPI + Ledoit-Wolf correlation — no-fill returns, bad-tick filter, broad selloff stress và macro regime map",
    ...
    ToolDefinition(
        ...
        branch="behavioral",
        name="🛡️ VaRES Engine",
        desc="VaR/ES contagion + complacency — prior-window no-lookahead, bad-tick filter, valid denominator, VNINDEX proxy",
    ...
    ToolDefinition(
        ...
        desc="VIN-group PCA composite vs VNINDEX — no-fill returns, OLS slope/correlation percentile, event-study coupling regime",
    ...
    ToolDefinition(
        ...
        desc="VNINDEX VaR/CVaR + EVT POT-GPD — prior-window no-lookahead, bad-tick filter, breach/tail-regime diagnostics",
    ...
    ToolDefinition(
        ...
        desc="ABM v4 early-warning monitor for leverage crowding, latent fragility and margin-cascade stress.",
