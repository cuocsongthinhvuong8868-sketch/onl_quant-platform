...
def render():
    ...
    with tab_current:
        if ai_cache_file.exists():
            ...
            render_sync_button(ai_cache_file, key_suffix="dispersion")
    ...
    with tab_history:
        ...
        _all_caches = list(DATA_LAKE.glob("daily_cache/dispersion_*.txt"))
        _options = build_history_options(_all_caches, "dispersion", AI_PROVIDER_MAP)
        if not _options:
