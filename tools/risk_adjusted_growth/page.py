...
def render():
    ...
    ai_cache_file = DATA_LAKE / "daily_cache" / f"risk_adjusted_growth_{today_str}.txt"
    ...
    if ai_cache_file.exists():
        ...
        if st.button("🐺 Phân tích Economic Alpha (Moonshot AI v1 128k)", type="primary", use_container_width=True):
